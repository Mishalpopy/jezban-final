  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `url("assets/img/breadcrumb/breadcrumb-bg-type.jpg")`,
        }}
      >
          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className="breadcrumb__content text-center p-relative z-index-1">
                <h3 className="breadcrumb__title"> TYPES OF FLIES & CONTROL</h3>
                <div className="breadcrumb__list">
                  <span>
                    <Link to="/">Home</Link>
                  </span>
                  <span className="dvdr">:</span>
                  <span>TYPES OF FLIES & CONTROL</span>
                </div>
              </div>
            </div>
          </div>
